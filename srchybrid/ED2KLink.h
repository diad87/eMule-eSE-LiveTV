...
public:
	...
	virtual class CED2KStreamLink* GetStreamLink()			{ return NULL; }
};
...
class CED2KStreamLink : public CED2KLink
{
public:
	...
	void GetLink(CString &lnk) const;
	CED2KStreamLink* GetStreamLink()					{ return this; }
...
private:
	CED2KStreamLink();
	CED2KStreamLink(const CED2KStreamLink&) = delete;
