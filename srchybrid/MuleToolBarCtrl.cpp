...
void CMuleToolbarCtrl::ChangeToolbarBitmap(const CString &path, bool bRefresh)
{
	...
	if (!bResult) {
		...
		ImageList.Add(CTempIconLoader(_T("LIVESTREAM"), m_sizBtnBmp.cx, m_sizBtnBmp.cy));
		ImageList.Add(CTempIconLoader(_T("ESESERVER"),  m_sizBtnBmp.cx, m_sizBtnBmp.cy));
