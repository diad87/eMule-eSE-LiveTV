...
// eSE Live — P2P live streaming protocol opcodes
#define OP_LIVE_ANNOUNCE		0xC0	// <StreamHash 16><Title len><Category 1><Language 2><Bitrate 4><Flags 1>
#define OP_LIVE_REQUEST			0xC1	// <StreamHash 16><SegmentIndex 4>
#define OP_LIVE_CHUNK			0xC2	// <StreamHash 16><SegmentIndex 4><ChunkSize 4><Payload ChunkSize>
#define OP_LIVE_SUBSCRIBE		0xC3	// <StreamHash 16><ViewerHash 16>
#define OP_LIVE_UNSUBSCRIBE		0xC4	// <StreamHash 16><ViewerHash 16>
#define OP_LIVE_PEER_LIST		0xCA	// <StreamHash 16><Count 2>(<IP 4><Port 2><Score 1>)[Count]  (0xC5 reserved for OP_EMULEPROT)
...
// NOTE: eSE Live Streaming Opcodes are defined above (0xC0-0xCA range).
// The duplicate block (0xB3-0xB9) was removed — it caused redefinition
// conflicts with the canonical definitions at line 290.
