...
bool CSearchResultsWnd::DoNewKadSearch(SSearchParams *pParams)
{
	...
	// BUGFIX (eSE): Guard against empty keyword before accessing [0] index (Access Violation)
	...
	// BUGFIX (eSE): Validate keyword BEFORE calling GetSearchPacket to avoid crash inside the parser
