...
// eSE: NAT Hole-Punch telemetry counters (static definitions)
volatile DWORD	CStatistics::m_dwHolePunchAttempts;
volatile DWORD	CStatistics::m_dwHolePunchSuccess;
...
CStatistics::CStatistics()
{
	...
	// eSE: NAT Hole-Punch telemetry
	m_dwHolePunchAttempts = 0;
	m_dwHolePunchSuccess = 0;
